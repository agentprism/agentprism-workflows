...
- 7054ba4: Publish the `workflow` tool's input as one flat, strict JSON Schema object instead of a top-level `oneOf`.
...
- Updated dependencies [7054ba4]
  - @automatalabs/workflows@7.1.0

## 8.0.2

### Patch Changes

- @automatalabs/workflows@7.0.2
...
- Updated dependencies [71ab48d]
  ...
  - @automatalabs/repl-engine@0.4.40
  - @automatalabs/workflows@6.2.5
...
- Updated dependencies [76bbf8f]
  ...
  - @automatalabs/workflows@6.2.0
  - @automatalabs/repl-engine@0.4.35
...
- Updated dependencies [5311099]
  ...
  - @automatalabs/repl-engine@0.4.34
  - @automatalabs/workflows@6.1.1
...
- Updated dependencies [07505a3]
  ...
  - @automatalabs/workflows@6.1.0
  - @automatalabs/repl-engine@0.4.33

## 7.0.1

### Patch Changes

- @automatalabs/repl-engine@0.4.32
- @automatalabs/workflows@6.0.1
...
- @automatalabs/repl-engine@0.4.30
- @automatalabs/workflows@5.1.1

## 6.2.0

### Minor Changes

- 87d684a: Claude Code channels: the run monitor's automatic updates, delivered without a panel.
...
- d5968bd: Daemon lifetime: orphaned daemons are no longer possible to create by accident, and none can hide from the CLI.
...
- Updated dependencies [d5968bd]
  - @automatalabs/workflows@5.1.0
  - @automatalabs/repl-engine@0.4.29

## 6.0.1

### Patch Changes

- @automatalabs/repl-engine@0.4.28
- @automatalabs/workflows@5.0.1
...
- @automatalabs/repl-engine@0.4.25
- @automatalabs/workflows@3.1.1
...
- Updated dependencies [872db50]
  - @automatalabs/workflows@3.1.0
...
- Updated dependencies [e1fd6c2]
  ...
  - @automatalabs/repl-engine@0.4.21

## 3.0.1

### Patch Changes

- @automatalabs/repl-engine@0.4.20
...
- 67ca48d: Replace the MCP `docs` tool and `agentprism://docs/*` resources with the accepted SEP-2640 Skills Extension. The server now publishes separate workflow-authoring and REPL-orchestration Agent Skills through `skills/list`, `skills/get`, standard resource reads, and capability-gated directory reads.

### Patch Changes

- Updated dependencies [67ca48d]
  - @automatalabs/workflows@2.0.0
  - @automatalabs/repl-engine@0.4.19

## 2.0.3

### Patch Changes

- @automatalabs/repl-engine@0.4.18
...
- @automatalabs/repl-engine@0.4.17
