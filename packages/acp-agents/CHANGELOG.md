...
- 93382fa: Drive the Claude backend with `@agentclientprotocol/claude-agent-acp@0.81.2` (from 0.79.0) and carry its wrapped runtime to `@anthropic-ai/claude-agent-sdk@0.3.281` through the workspace override, ahead of the adapter's own 0.3.280 pin.
...
- Updated dependencies [164968d]
- Updated dependencies [93382fa]
  - @automatalabs/codex-acp@2.9.0
  - @automatalabs/pi-acp@0.9.4
