...
// Before reusing it, run config for each exact model and keep a mode only when the current
// availableModes still lists it; no advertised modes means omit it. OpenCode stays unset here.
