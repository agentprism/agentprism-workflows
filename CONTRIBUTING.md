...
| `packages/acp-server` | Transport-selected, connection-pinned ACP V1 proxy over stdio, Streamable HTTP, or WebSocket, with a dedicated backend-discovery endpoint (bin `agentprism-acp-server`). |
