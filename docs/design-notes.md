...
- **`@agentclientprotocol/claude-agent-acp@0.67.0`** — ACP server wrapping Claude.
...
### 6.2 Claude — `@agentclientprotocol/claude-agent-acp@0.67.0` → `@anthropic-ai/claude-agent-sdk@0.3.224`
...
- `@agentclientprotocol/claude-agent-acp@0.67.0` (wraps `@anthropic-ai/claude-agent-sdk@0.3.224`) — https://github.com/agentclientprotocol/claude-agent-acp
